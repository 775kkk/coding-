...
- `lib`: the folder to maintain dependencies - видимо это подпапка для вспомогательных фалов в src, но тк у меня не проект, врядли я ей буду пользоваться... `Буду использовать эту папку как архив`
