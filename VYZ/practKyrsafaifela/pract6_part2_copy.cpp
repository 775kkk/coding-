...
int VblCHISLI(char* strM){
        ...
        else if (strM[i] >= '0' && strM[i] <= '9')//если число
        {
            ...
            // <\просто факт что прошел знак>
                ...
                {   
                    ...
                    printf("sikl %i mejdy %i, result=%i, rootResult=%i, mainchisl=%i, secondChisl=%i, vozvedeynieVstepen=%i, flagZnaka=%i,flagPriorityOP=%i,\n",i,i+1,result,mainRoot->SecondResult,mainRoot->mainChisl,mainRoot->secondChisl,mainRoot->vozvedeynieVstepen,mainRoot->flagZnaka,mainRoot->flagPriorityOP);
    ...
    /*для тестов*/ 
    printf("sikl %i, result=%i, rootResult=%i, mainchisl=%i, secondChisl=%i, vozvedeynieVstepen=%i, flagZnaka=%i,flagPriorityOP=%i,\n",i,result,mainRoot->SecondResult,mainRoot->mainChisl,mainRoot->secondChisl,mainRoot->vozvedeynieVstepen,mainRoot->flagZnaka,mainRoot->flagPriorityOP);

    }

    /*для тестов*/ 
    printf("sikl PREend,  result=%i, rootResult=%i, mainchisl=%i, secondChisl=%i, vozvedeynieVstepen=%i, flagZnaka=%i,flagPriorityOP=%i,\n",result,mainRoot->SecondResult,mainRoot->mainChisl,mainRoot->secondChisl,mainRoot->vozvedeynieVstepen,mainRoot->flagZnaka,mainRoot->flagPriorityOP);
    ...
    /*для тестов*/ 
    printf("sikl end, result=%i, rootResult=%i, mainchisl=%i, secondChisl=%i, vozvedeynieVstepen=%i, flagZnaka=%i,flagPriorityOP=%i,\n",result,mainRoot->SecondResult,mainRoot->mainChisl,mainRoot->secondChisl,mainRoot->vozvedeynieVstepen,mainRoot->flagZnaka,mainRoot->flagPriorityOP);
